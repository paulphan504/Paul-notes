##### **How to create ECs**
##### **How to create VPC (virtual ip and subnet for network private local connect vm together)**
##### **How to create EIP (IP Wan public assign to vm, use for connect ssh vm external on internet)**
